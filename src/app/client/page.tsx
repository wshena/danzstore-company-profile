...
const page = () => {
  return (
    <main className="">
      {/* title */}
      <TitleSection title='Klien Kami' breadcrumb={
        <Breadcrumbs aria-label="breadcrumb">
          <Link underline="hover" color="inherit" href="/">
            Home
          </Link>
          <Typography sx={{ color: 'text.primary' }}>Klien</Typography>
        </Breadcrumbs>
      } />
        ...
        <ContentContainer>
          <div className="flex flex-col items-center gap-10">
            ...
            <div className="text-center space-y-1">
              <span className="text-sm md:text-md text-gray-500 uppercase">KLIEN Jasa Website Surabaya</span>
              <h1 className="capitalize font-semibold text-gray-700 text-[1.5rem] md:text-[2rem] lg:text-[2.5rem]">Dipercaya 2000+ Happy Client</h1>
